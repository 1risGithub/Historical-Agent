...
Project: **The Historical Court — Multi-Agent System using Google Agent Development Kit (ADK)**
...
* Implemented Parallel Research Agents
* Developed Loop Control using `exit_loop` Tool
* Managed Session State and Workflow Logic
* Implemented Wikipedia Research Integration
* Generated Automated Historical Verdict Reports

---

### 🎓 Course Assignment

Multi-Agent System Development using Google ADK
